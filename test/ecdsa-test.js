...
describe("ECDSA", function () {
  function test(name) {
    describe("curve " + name, function () {
      ...
      it("should have another signature with pers", function () {
        ...
        assert.notEqual(
          sign1.r.toArray().concat(sign1.s.toArray()),
      ...
      it("should not verify signature with wrong private key", function () {
        ...
        var wrong = ecdsa.keyFromPrivate(
          keys.getPrivate("hex") + keys.getPrivate("hex")
        );
        assert(!ecdsa.verify(msg, signature, wrong), "Wrong key verify");
      });
    });
  ...
  describe("RFC6979 vector", function () {
    function test(opt) {
      opt.cases.forEach(function (c) {
        ...
        it(descr, function () {
          ...
          assert.ok(
            ecdsa.keyFromPublic(opt.pub).validate().result,
            "Invalid public key"
          );
    ...
    test({
      ...
      key:
        "6b9d3dad2e1b8c1c05b19875b6659f4de23c3b667bf297ba9aa4774078713" +
        "7d896d5724e4c70a825f872c9ea60d2edf5",
      pub: {
        x:
          "ec3a4e415b4e19a4568618029f427fa5da9a8bc4ae92e02e06aae5286b30" +
      ...
      cases: [
        {
          ...
          hash: hash.sha224,
          r:
            "42356e76b55a6d9b4631c865445dbe54e056d3b3431766d05092447" +
            "93c3f9366450f76ee3de43f5a125333a6be060122",
          s:
            "9da0c81787064021e78df658f2fbb0b042bf304665db721f077a429" +
        ...
        },
        {
          ...
          hash: hash.sha384,
          r:
            "94edbb92a5ecb8aad4736e56c691916b3f88140666ce9fa73d6" +
            "4c4ea95ad133c81a648152e44acf96e36dd1e80fabe46",
          s:
            "99ef4aeb15f178cea1fe40db2603138f130e740a19624526203b" +
        ...
        },
        {
          ...
          hash: hash.sha384,
          r:
            "8203b63d3c853e8d77227fb377bcf7b7b772e97892a80f36a" +
            "b775d509d7a5feb0542a7f0812998da8f1dd3ca3cf023db",
          s:
            "ddd0760448d42d8a43af45af836fce4de8be06b485e9b61b827c2f13" +
    ...
    var vectors = [
      {
        curve: p256,
        pub:
          "041548fc88953e06cd34d4b300804c5322cb48c24aaaa4d0" +
      ...
      },
      {
        curve: p256,
        pub:
          "04ad8f60e4ec1ebdb6a260b559cb55b1e9d2c5ddd43a41a2" +
      ...
      },
      {
        curve: p256,
        pub:
          "0445bd879143a64af5746e2e82aa65fd2ea07bba4e355940" +
      ...
      },
      {
        curve: p256,
        pub:
          "040feb5df4cc78b35ec9c180cc0de5842f75f088b4845697" +
      ...
      },
      {
        curve: p384,
        pub:
          "0425e299eea9927b39fa92417705391bf17e8110b4615e9e" +
      ...
      },
      {
        curve: p384,
        pub:
          "04a328f65c22307188b4af65779c1d2ec821c6748c6bd8dc" +
      ...
      },
      {
        curve: p384,
        pub:
          "04242e8585eaa7a28cc6062cab4c9c5fd536f46b17be1728" +
      ...
      },
      {
        curve: p384,
        pub:
          "04cdf865dd743fe1c23757ec5e65fd5e4038b472ded2af26" +
  ...
  it("should fail to recover key when no quadratic residue available", function () {
    var ec = new elliptic.ec("secp256k1");
