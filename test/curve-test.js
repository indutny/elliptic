...
describe("Curve", function () {
  ...
  it("should be able to find a point given y coordinate for all edwards curves", function () {
    var curve = new elliptic.curve.edwards({
      p: new BN(
        "f7" + "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff07",
        16,
        "le"
      ),
      q: new BN(
        "71" + "c966d15fd444893407d3dfc46579f7ffffffffffffffffffffffffffffff01",
        16,
        "le"
      ),
      r: "4",
      ...
      // -1174 mod p
      d: new BN(
        "61" + "fbffffffffffffffffffffffffffffffffffffffffffffffffffffffffff07",
        16,
        "le"
      ),
      c: "1",
