  ...
  })(
    {
        ...
        function (e, t, i) {
          ...
          ((t.exports = d).prototype.point = function () {
            ...
            (d.prototype._fixedNafMul = function (e, t) {
              ...
              for (
                ...
                for (n = 0; n < d.length; n++)
                  (f = d[n]) === h
                    ? (c = c.mixedAdd(i.points[n]))
                    : f === -h && (c = c.mixedAdd(i.points[n].neg()));
                s = s.add(c);
              }
              return s.toP();
            }),
            (d.prototype._wnafMul = function (e, t) {
              for (
                var i = e._getNAFPoints(4),
                  r = i.wnd,
                  f = i.points,
                  d = x(t, r, this._bitLength),
              ...
              for (h = r - 1; 1 <= h; h -= 2) {
                ...
                if (1 === n[u] && 1 === n[b]) {
                  ...
                  0 === t[u].y.cmp(t[b].y)
                    ...
                    : 0 === t[u].y.cmp(t[b].y.redNeg())
                    ? ((l[1] = t[u].toJ().mixedAdd(t[b])),
                      (l[2] = t[u].add(t[b].neg())))
                    : ((l[1] = t[u].toJ().mixedAdd(t[b])),
                      (l[2] = t[u].toJ().mixedAdd(t[b].neg())));
                  ...
                  for (
                    s[u] = new Array(c), s[b] = new Array(c), _ = 0;
                    _ < c;
                    _++
                  ) {
                    var v = 0 | m[0][_],
                  ...
                  (s[u] = x(i[u], n[u], this._bitLength)),
                    (s[b] = x(i[b], n[b], this._bitLength)),
                ...
                for (_ = 0; _ < r; _++) {
                  ...
                  0 !== A &&
                    (0 < A
                      ? (d = a[_][(A - 1) >> 1])
                      : A < 0 && (d = a[_][(-A - 1) >> 1].neg()),
                    (y = "affine" === d.type ? y.mixedAdd(d) : y.add(d)));
                }
              }
        ...
        function (e, t, i) {
          ...
          function c(e, t, i, r, f) {
            n.BasePoint.call(this, e, "projective"),
              null === t && null === i && null === r
                ...
                : ((this.x = new d(t, 16)),
                  (this.y = new d(i, 16)),
                  (this.z = r ? new d(r, 16) : this.curve.one),
                  (this.t = f && new d(f, 16)),
          ...
          f(s, n),
            ...
            (s.prototype.pointFromX = function (e, t) {
              ...
              r = i.fromRed().isOdd();
              return (
                ((t && !r) || (!t && r)) && (i = i.redNeg()), this.point(e, i)
              );
            }),
            (s.prototype.pointFromY = function (e, t) {
              ...
              if (0 !== i.redSqr().redSub(r).cmp(this.zero))
                throw new Error("invalid point");
              return (
                i.fromRed().isOdd() !== t && (i = i.redNeg()), this.point(i, e)
              );
            }),
            ...
            (c.prototype._projDbl = function () {
              var e,
                ...
                s = this.y.redSqr();
              return (
                (d = this.curve.twisted
                  ? ((f = (i = this.curve._mulA(a)).redAdd(s)),
                    this.zOne
                      ? ((e = n
                          .redSub(a)
                          .redSub(s)
                        ...
                        f.redSqr().redSub(f).redSub(f))
                      : ((r = this.z.redSqr()),
                        (d = f.redSub(r).redISub(r)),
                        (e = n.redSub(a).redISub(s).redMul(d)),
                        (t = f.redMul(i.redSub(s))),
                        f.redMul(d)))
                  : ((i = a.redAdd(s)),
                    (r = this.curve._mulC(this.z).redSqr()),
                    (d = i.redSub(r).redSub(r)),
                    (e = this.curve._mulC(n.redISub(i)).redMul(d)),
                    (t = this.curve._mulC(i).redMul(a.redISub(s))),
                    i.redMul(d))),
                this.curve.point(e, t, d)
              );
            }),
            ...
            (c.prototype._projAdd = function (e) {
              var t,
                ...
                n = this.curve.twisted
                  ? ((t = i.redMul(n).redMul(d.redSub(this.curve._mulA(f)))),
                    a.redMul(n))
                  : ((t = i.redMul(n).redMul(d.redSub(f))),
                    this.curve._mulC(a).redMul(n));
      ...
      6: [
        function (e, t, i) {
          ...
          function s(e, t, i, r) {
            d.BasePoint.call(this, e, "affine"),
              null === t && null === i
          ...
          function c(e, t, i, r) {
            d.BasePoint.call(this, e, "jacobian"),
              null === t && null === i && null === r
          ...
          f(a, d),
                ...
                return (
                  (i = (
                    e.beta
                      ? new y(e.beta, 16)
                      : (i =
                          (r = this._getEndoRoots(this.p))[0].cmp(r[1]) < 0
                            ? r[0]
                            : r[1])
                  ).toRed(this.red)),
                  e.lambda
                    ? (t = new y(e.lambda, 16))
                    : ((r = this._getEndoRoots(this.n)),
                      0 === this.g.mul(r[0]).x.cmp(this.g.x.redMul(i))
                        ? (t = r[0])
                        : ((t = r[1]),
                          n(0 === this.g.mul(t).x.cmp(this.g.x.redMul(i))))),
                  {
                    beta: i,
                    lambda: t,
                    basis: e.basis
                      ? e.basis.map(function (e) {
                          return { a: new y(e.a, 16), b: new y(e.b, 16) };
                        })
            ...
            (a.prototype._getEndoBasis = function (e) {
              ...
              e = r.sqr().add(f.sqr());
              return (
                0 <= d.sqr().add(n.sqr()).cmp(e) && ((d = t), (n = i)),
                r.negative && ((r = r.neg()), (f = f.neg())),
                d.negative && ((d = d.neg()), (n = n.neg())),
                [
                  { a: r, b: f },
                  { a: d, b: n },
                ]
            ...
            (a.prototype._endoSplit = function (e) {
              var t = this.endo.basis,
                ...
                i = f.mul(i.b),
                r = d.mul(r.b);
              return { k1: e.sub(n).sub(t), k2: i.add(r).neg() };
            }),
            (a.prototype.pointFromX = function (e, t) {
              var i = (e = !(e = new y(e, 16)).red ? e.toRed(this.red) : e)
                  .redSqr()
                  .redMul(e)
              ...
              i = r.fromRed().isOdd();
              return (
                ((t && !i) || (!t && i)) && (r = r.redNeg()), this.point(e, r)
              );
            }),
            ...
            (a.prototype._endoWnafMulAdd = function (e, t, i) {
              for (
                ...
                n.k1.negative && (n.k1.ineg(), (a = a.neg(!0))),
                  n.k2.negative && (n.k2.ineg(), (s = s.neg(!0))),
                  (r[2 * d] = a),
                  (r[2 * d + 1] = s),
                  (f[2 * d] = n.k1),
                  (f[2 * d + 1] = n.k2);
              ...
              for (
                var i = this._wnafMulAdd(1, r, f, 2 * d, i), c = 0;
                c < 2 * d;
                c++
              )
                (r[c] = null), (f[c] = null);
            ...
            (s.prototype.add = function (e) {
              ...
              var t = this.y.redSub(e.y),
                e = (t =
                  0 !== t.cmpn(0) ? t.redMul(this.x.redSub(e.x).redInvm()) : t)
                  .redSqr()
                  .redISub(this.x)
                  .redISub(e.x),
            ...
            (s.prototype.mulAdd = function (e, t, i) {
              ...
              return this.curve.endo
                ? this.curve._endoWnafMulAdd(t, i)
                : this.curve._wnafMulAdd(1, t, i, 2);
            }),
            (s.prototype.jmulAdd = function (e, t, i) {
              (t = [this, t]), (i = [e, i]);
              return this.curve.endo
                ? this.curve._endoWnafMulAdd(t, i, !0)
                : this.curve._wnafMulAdd(1, t, i, 2, !0);
            }),
            (s.prototype.eq = function (e) {
              return (
                this === e ||
            ...
            (s.prototype.neg = function (e) {
              if (this.inf) return this;
              var t,
                i = this.curve.point(this.x, this.y.redNeg());
              return (
                e &&
                  this.precomputed &&
                  ((t = this.precomputed),
            ...
            (c.prototype.add = function (e) {
              ...
              (f = t.redSqr()),
                (n = f.redMul(t)),
                (r = r.redMul(f)),
                (f = i.redSqr().redIAdd(n).redISub(r).redISub(r)),
                (n = i.redMul(r.redISub(f)).redISub(d.redMul(n))),
            ...
            (c.prototype.mixedAdd = function (e) {
              ...
              (r = e.redSqr()),
                (d = r.redMul(e)),
                (i = i.redMul(r)),
                (r = t.redSqr().redIAdd(d).redISub(i).redISub(i)),
                (d = t.redMul(i.redISub(r)).redISub(f.redMul(d))),
                (e = this.z.redMul(e));
              ...
              var e,
                ...
                d = this.zOne
                  ...
                  : ((f = this.x.redSqr()),
                    ...
                    (t = r.redMul(i.redISub(e)).redISub(d)),
                    (d = this.y.redMul(this.z)).redIAdd(d));
                ...
                this.zOne
                  ? ((e = this.x.redSqr()),
                    ...
                    (n = (n = this.x
                      ...
                      .redISub(r)).redIAdd(n)),
                    (i = f =
                      (a = e.redAdd(e).redIAdd(e).redIAdd(this.curve.a))
                        .redSqr()
                        .redISub(n)
                        .redISub(n)),
                    (d = (d = (d = r.redIAdd(r)).redIAdd(d)).redIAdd(d)),
                    (t = a.redMul(n.redISub(f)).redISub(d)),
                    (e = this.y.redAdd(this.y)))
                  : ((r = this.z.redSqr()),
                    (a = this.y.redSqr()),
                    (n = this.x.redMul(a)),
                    (f = (f = this.x.redSub(r).redMul(this.x.redAdd(r)))
                      .redAdd(f)
                      .redIAdd(f)),
                    (n = (d = (d = n.redIAdd(n)).redIAdd(d)).redAdd(d)),
                    (i = f.redSqr().redISub(n)),
                    (e = this.y.redAdd(this.z).redSqr().redISub(a).redISub(r)),
                    (a = (a = (a = (a = a.redSqr()).redIAdd(a)).redIAdd(
                      a
                    )).redIAdd(a)),
                    (t = f.redMul(d.redISub(i)).redISub(a))),
            ...
            (c.prototype.trpl = function () {
              ...
              var e = this.x.redSqr(),
                ...
                e = (n = (n = (n = n.redIAdd(n)).redAdd(n).redIAdd(n)).redISub(
                  d
                )).redSqr(),
                r = r.redIAdd(r);
              r = (r = (r = r.redIAdd(r)).redIAdd(r)).redIAdd(r);
              (d = f.redIAdd(n).redSqr().redISub(d).redISub(e).redISub(r)),
                (t = t.redMul(d));
          ...
          ((t.exports = s).prototype.keyPair = function (e) {
            ...
            (s.prototype.sign = function (e, t, i, r) {
              ...
              for (
                ...
                if (
                  !(
                    (s = this._truncateToN(s, !0)).cmpn(1) <= 0 || 0 <= s.cmp(n)
                  )
                ) {
                  var c = this.g.mul(s);
                  if (!c.isInfinity()) {
                    ...
                    if (0 !== o.cmpn(0)) {
                      ...
                      if (0 !== (s = s.umod(this.n)).cmpn(0)) {
                        h =
                          (c.getY().isOdd() ? 1 : 0) | (0 !== h.cmp(o) ? 2 : 0);
                        return (
                          r.canonical &&
                            0 < s.cmp(this.nh) &&
                            ((s = this.n.sub(s)), (h ^= 1)),
                          new l({ r: o, s: s, recoveryParam: h })
                        );
                      }
                    }
                  }
            ...
            (s.prototype.verify = function (e, t, i, r) {
              ...
              return this.curve._maxwellTrick
                ? !(f = this.g.jmulAdd(e, i.getPublic(), t)).isInfinity() &&
                    f.eqXToP(r)
                : !(f = this.g.mulAdd(e, i.getPublic(), t)).isInfinity() &&
                    0 === f.getX().umod(this.n).cmp(r);
            }),
            (s.prototype.recoverPubKey = function (e, t, i, r) {
              ...
              var f = this.n,
                ...
                e = 1 & i,
                i = i >> 1;
              if (0 <= n.cmp(this.curve.p.umod(this.curve.n)) && i)
                throw new Error("Unable to find sencond key candinate");
              n = i
                ? this.curve.pointFromX(n.add(this.curve.n), e)
                : this.curve.pointFromX(n, e);
              (t = t.r.invm(f)),
                (d = f.sub(d).mul(t).umod(f)),
                (f = r.mul(t).umod(f));
              return this.g.mulAdd(d, n, f);
            }),
            (s.prototype.getKeyRecoveryParam = function (e, t, i, r) {
              if (null !== (t = new l(t, r)).recoveryParam)
      ...
      11: [
        function (e, t, i) {
          ...
          ((t.exports = h).prototype.sign = function (e, t) {
            ...
            return this.makeSignature({ R: f, S: i, Rencoded: t });
          }),
          ...
          !(function (e, t) {
            ...
            (m.isBN = function (e) {
              ...
              (m.prototype._initArray = function (e, t, i) {
                if ((p("number" == typeof e.length), e.length <= 0))
                ...
                var n = 0;
                if ("be" === i)
                  for (d = e.length - 1, r = 0; 0 <= d; d -= 3)
                    (f = e[d] | (e[d - 1] << 8) | (e[d - 2] << 16)),
                      (this.words[r] |= (f << n) & 67108863),
                      (this.words[r + 1] = (f >>> (26 - n)) & 67108863),
                      26 <= (n += 24) && ((n -= 26), r++);
                else if ("le" === i)
                  for (r = d = 0; d < e.length; d += 3)
                    (f = e[d] | (e[d + 1] << 8) | (e[d + 2] << 16)),
                      (this.words[r] |= (f << n) & 67108863),
                      (this.words[r + 1] = (f >>> (26 - n)) & 67108863),
                      26 <= (n += 24) && ((n -= 26), r++);
              ...
              (m.prototype._parseHex = function (e, t) {
                ...
                for (var f = 0, r = e.length - 6, d = 0; t <= r; r -= 6)
                  (i = n(e, r, r + 6)),
                    (this.words[d] |= (i << f) & 67108863),
                    (this.words[d + 1] |= (i >>> (26 - f)) & 4194303),
                    26 <= (f += 24) && ((f -= 26), d++);
                r + 6 !== t &&
                  ((i = n(e, t, r + 6)),
                  (this.words[d] |= (i << f) & 67108863),
                ...
                for (
                  ...
                  (s = o(e, c, c + r, t)),
                    ...
                    this.words[0] + s < 67108864
                      ...
                      : this._iaddn(s);
                if (0 != n) {
                  for (var h = 1, s = o(e, c, e.length, t), c = 0; c < n; c++)
                    h *= t;
                  this.imuln(h),
                    this.words[0] + s < 67108864
                      ? (this.words[0] += s)
              ...
              for (var n = 1; n < r; n++) {
                for (
                  ...
                  var o,
                    u = (n - h) | 0;
                  (a +=
                    ((o = (0 | e.words[u]) * (0 | t.words[h]) + s) / 67108864) |
                    0),
                    (s = 67108863 & o);
                }
                (i.words[n] = 0 | s), (d = 0 | a);
            ...
            (m.prototype.toString = function (e, t) {
              ...
              if (e === (0 | e) && 2 <= e && e <= 36) {
                ...
                for (a = "", (h = this.clone()).negative = 0; !h.isZero(); ) {
                  var h,
                    o = h.modn(c).toString(e);
                  a = (h = h.idivn(c)).isZero()
                    ? o + a
                    : u[s - o.length] + o + a;
                }
              ...
              (m.prototype.toNumber = function () {
                ...
                return (
                  2 === this.length
                    ...
                    : 2 < this.length &&
                      p(!1, "Number can only safely store up to 53 bits"),
                  0 !== this.negative ? -e : e
                );
              }),
              ...
              (m.prototype.toArrayLike = function (e, t, i) {
                ...
                if (t) {
                  for (n = 0; !s.isZero(); n++)
                    (d = s.andln(255)), s.iushrn(8), (a[n] = d);
                  for (; n < f; n++) a[n] = 0;
                } else {
                  for (n = 0; n < f - r; n++) a[n] = 0;
                  for (n = 0; !s.isZero(); n++)
                    (d = s.andln(255)), s.iushrn(8), (a[f - n - 1] = d);
                }
                return a;
              }),
              Math.clz32
              ...
              (m.prototype.iuand = function (e) {
                for (
                  var t = this.length > e.length ? e : this, i = 0;
                  i < t.length;
                  i++
                )
              ...
              (m.prototype.inotn = function (e) {
                ...
                return (
                  0 < e &&
                    (this.words[i] = ~this.words[i] & (67108863 >> (26 - e))),
                  this.strip()
                );
              }),
              ...
              (m.prototype.isub = function (e) {
                ...
                for (var d = 0, n = 0; n < r.length; n++)
                  (d = (t = (0 | i.words[n]) - (0 | r.words[n]) + d) >> 26),
                    (this.words[n] = 67108863 & t);
                for (; 0 !== d && n < i.length; n++)
                  (d = (t = (0 | i.words[n]) + d) >> 26),
                    (this.words[n] = 67108863 & t);
            ...
            var d = function (e, t, i) {
              ...
              var X =
                  (((0 + Math.imul(a, O)) | 0) +
                    ((8191 & (J = (Math.imul(a, F) + Math.imul(s, O)) | 0)) <<
                      13)) |
                  0,
                ee = (((Math.imul(s, F) + (J >>> 13)) | 0) + (X >>> 26)) | 0;
              (X &= 67108863),
                (T = Math.imul(h, O)),
                (J = (Math.imul(h, F) + Math.imul(o, O)) | 0),
                (W = Math.imul(o, F));
              G =
                (((ee + ((T + Math.imul(a, C)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, Z)) | 0) + Math.imul(s, C)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, Z)) | 0) + (J >>> 13)) | 0) +
                  (G >>> 26)) |
                0),
                (G &= 67108863),
                (T = Math.imul(b, O)),
                (J = (Math.imul(b, F) + Math.imul(l, O)) | 0),
                (W = Math.imul(l, F)),
                (T = (T + Math.imul(h, C)) | 0),
                (J = (((J + Math.imul(h, Z)) | 0) + Math.imul(o, C)) | 0),
                (W = (W + Math.imul(o, Z)) | 0);
              n =
                (((ee + ((T + Math.imul(a, H)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, D)) | 0) + Math.imul(s, H)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, D)) | 0) + (J >>> 13)) | 0) +
                  (n >>> 26)) |
                0),
                (n &= 67108863),
                (T = Math.imul(m, O)),
                (J = (Math.imul(m, F) + Math.imul(v, O)) | 0),
                (W = Math.imul(v, F)),
                (T = (T + Math.imul(b, C)) | 0),
                (J = (((J + Math.imul(b, Z)) | 0) + Math.imul(l, C)) | 0),
                (W = (W + Math.imul(l, Z)) | 0),
                (T = (T + Math.imul(h, H)) | 0),
                (J = (((J + Math.imul(h, D)) | 0) + Math.imul(o, H)) | 0),
                (W = (W + Math.imul(o, D)) | 0);
              p =
                (((ee + ((T + Math.imul(a, K)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, V)) | 0) + Math.imul(s, K)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, V)) | 0) + (J >>> 13)) | 0) +
                  (p >>> 26)) |
                0),
                (p &= 67108863),
                (T = Math.imul(y, O)),
                (J = (Math.imul(y, F) + Math.imul(M, O)) | 0),
                (W = Math.imul(M, F)),
                (T = (T + Math.imul(m, C)) | 0),
                (J = (((J + Math.imul(m, Z)) | 0) + Math.imul(v, C)) | 0),
                (W = (W + Math.imul(v, Z)) | 0),
                (T = (T + Math.imul(b, H)) | 0),
                ...
                (W = (W + Math.imul(o, V)) | 0);
              A =
                (((ee + ((T + Math.imul(a, U)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, Y)) | 0) + Math.imul(s, U)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, Y)) | 0) + (J >>> 13)) | 0) +
                  (A >>> 26)) |
                0),
                (A &= 67108863),
                (T = Math.imul(S, O)),
                (J = (Math.imul(S, F) + Math.imul(_, O)) | 0),
                (W = Math.imul(_, F)),
                (T = (T + Math.imul(y, C)) | 0),
                (J = (((J + Math.imul(y, Z)) | 0) + Math.imul(M, C)) | 0),
                (W = (W + Math.imul(M, Z)) | 0),
                (T = (T + Math.imul(m, H)) | 0),
                ...
                (W = (W + Math.imul(o, Y)) | 0);
              f =
                (((ee + ((T + Math.imul(a, Q)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, $)) | 0) + Math.imul(s, Q)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, $)) | 0) + (J >>> 13)) | 0) +
                  (f >>> 26)) |
                0),
                (f &= 67108863),
                (T = Math.imul(x, O)),
                (J = (Math.imul(x, F) + Math.imul(I, O)) | 0),
                (W = Math.imul(I, F)),
                (T = (T + Math.imul(S, C)) | 0),
                (J = (((J + Math.imul(S, Z)) | 0) + Math.imul(_, C)) | 0),
                (W = (W + Math.imul(_, Z)) | 0),
                (T = (T + Math.imul(y, H)) | 0),
              ...
              r =
                (((ee + ((T + Math.imul(a, c)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, u)) | 0) + Math.imul(s, c)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, u)) | 0) + (J >>> 13)) | 0) +
                  (r >>> 26)) |
                0),
                (r &= 67108863),
                (T = Math.imul(q, O)),
                (J = (Math.imul(q, F) + Math.imul(R, O)) | 0),
                (W = Math.imul(R, F)),
                (T = (T + Math.imul(x, C)) | 0),
                (J = (((J + Math.imul(x, Z)) | 0) + Math.imul(I, C)) | 0),
                (W = (W + Math.imul(I, Z)) | 0),
                (T = (T + Math.imul(S, H)) | 0),
                ...
                (W = (W + Math.imul(o, u)) | 0);
              e =
                (((ee + ((T + Math.imul(a, g)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, w)) | 0) + Math.imul(s, g)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, w)) | 0) + (J >>> 13)) | 0) +
                  (e >>> 26)) |
                0),
                (e &= 67108863),
                (T = Math.imul(P, O)),
                (J = (Math.imul(P, F) + Math.imul(j, O)) | 0),
                (W = Math.imul(j, F)),
                (T = (T + Math.imul(q, C)) | 0),
                (J = (((J + Math.imul(q, Z)) | 0) + Math.imul(R, C)) | 0),
                (W = (W + Math.imul(R, Z)) | 0),
                (T = (T + Math.imul(x, H)) | 0),
                ...
                (W = (W + Math.imul(o, w)) | 0);
              t =
                (((ee + ((T + Math.imul(a, z)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, k)) | 0) + Math.imul(s, z)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, k)) | 0) + (J >>> 13)) | 0) +
                  (t >>> 26)) |
                0),
                (t &= 67108863),
                (T = Math.imul(E, O)),
                (J = (Math.imul(E, F) + Math.imul(B, O)) | 0),
                (W = Math.imul(B, F)),
                (T = (T + Math.imul(P, C)) | 0),
                (J = (((J + Math.imul(P, Z)) | 0) + Math.imul(j, C)) | 0),
                (W = (W + Math.imul(j, Z)) | 0),
                (T = (T + Math.imul(q, H)) | 0),
                ...
                (W = (W + Math.imul(o, k)) | 0);
              a =
                (((ee + ((T + Math.imul(a, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(a, L)) | 0) + Math.imul(s, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(s, L)) | 0) + (J >>> 13)) | 0) +
                  (a >>> 26)) |
                0),
                (a &= 67108863),
                (T = Math.imul(E, C)),
                (J = (Math.imul(E, Z) + Math.imul(B, C)) | 0),
                (W = Math.imul(B, Z)),
                (T = (T + Math.imul(P, H)) | 0),
                ...
                (W = (W + Math.imul(l, k)) | 0);
              h =
                (((ee + ((T + Math.imul(h, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(h, L)) | 0) + Math.imul(o, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(o, L)) | 0) + (J >>> 13)) | 0) +
                  (h >>> 26)) |
                0),
                (h &= 67108863),
                (T = Math.imul(E, H)),
                ...
                (W = (W + Math.imul(v, k)) | 0);
              b =
                (((ee + ((T + Math.imul(b, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(b, L)) | 0) + Math.imul(l, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(l, L)) | 0) + (J >>> 13)) | 0) +
                  (b >>> 26)) |
                0),
                (b &= 67108863),
                (T = Math.imul(E, K)),
                ...
                (W = (W + Math.imul(M, k)) | 0);
              m =
                (((ee + ((T + Math.imul(m, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(m, L)) | 0) + Math.imul(v, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(v, L)) | 0) + (J >>> 13)) | 0) +
                  (m >>> 26)) |
                0),
                (m &= 67108863),
                (T = Math.imul(E, U)),
                ...
                (W = (W + Math.imul(_, k)) | 0);
              y =
                (((ee + ((T + Math.imul(y, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(y, L)) | 0) + Math.imul(M, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(M, L)) | 0) + (J >>> 13)) | 0) +
                  (y >>> 26)) |
                0),
                (y &= 67108863),
                (T = Math.imul(E, Q)),
                ...
                (W = (W + Math.imul(I, k)) | 0);
              S =
                (((ee + ((T + Math.imul(S, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(S, L)) | 0) + Math.imul(_, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(_, L)) | 0) + (J >>> 13)) | 0) +
                  (S >>> 26)) |
                0),
                (S &= 67108863),
                (T = Math.imul(E, c)),
                ...
                (W = (W + Math.imul(R, k)) | 0);
              x =
                (((ee + ((T + Math.imul(x, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(x, L)) | 0) + Math.imul(I, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(I, L)) | 0) + (J >>> 13)) | 0) +
                  (x >>> 26)) |
                0),
                (x &= 67108863),
                (T = Math.imul(E, g)),
                ...
                (W = (W + Math.imul(j, k)) | 0);
              q =
                (((ee + ((T + Math.imul(q, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(q, L)) | 0) + Math.imul(R, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(R, L)) | 0) + (J >>> 13)) | 0) +
                  (q >>> 26)) |
                0),
                (q &= 67108863),
                (T = Math.imul(E, z)),
                ...
                (W = Math.imul(B, k));
              P =
                (((ee + ((T + Math.imul(P, N)) | 0)) | 0) +
                  ((8191 &
                    (J =
                      (((J + Math.imul(P, L)) | 0) + Math.imul(j, N)) | 0)) <<
                    13)) |
                0;
              (ee =
                (((((W + Math.imul(j, L)) | 0) + (J >>> 13)) | 0) +
                  (P >>> 26)) |
                0),
                (P &= 67108863);
              N =
                (((ee + Math.imul(E, N)) | 0) +
                  ((8191 & (J = (Math.imul(E, L) + Math.imul(B, N)) | 0)) <<
                    13)) |
                0;
              return (
                (ee = (((Math.imul(B, L) + (J >>> 13)) | 0) + (N >>> 26)) | 0),
                (N &= 67108863),
                (d[0] = X),
                (d[1] = G),
                (d[2] = n),
            ...
            Math.imul || (d = f),
                  ...
                  t = (
                    10 === this.length && 10 === e.length
                      ...
                      ? function (e, t, i) {
                          ...
                          for (var r = 0, f = 0, d = 0; d < i.length - 1; d++) {
                            for (
                              var n = f,
                                f = 0,
                                a = 67108863 & r,
                                s = Math.min(d, t.length - 1),
                                c = Math.max(0, d - e.length + 1);
                              c <= s;
                              c++
                            ) {
                              var h = d - c,
                          ...
                          return (
                            0 !== r ? (i.words[d] = r) : i.length--, i.strip()
                          );
                        }
                      : a
                  )(this, e, t);
                  ...
                  for (
                    ...
                    for (var o = s, u = c, b = 0; b < n; b++) {
                      ...
                      (i[h + b] = l + g),
                        ...
                        (r[h + b + n] = p - v),
                        b !== a &&
                          ((m = s * o - c * u), (u = s * u + c * o), (o = m));
                    }
              }),
              (s.prototype.guessLen13b = function (e, t) {
                for (
                  var e = 1 & (r = 1 | Math.max(t, e)), i = 0, r = (r / 2) | 0;
                  r;
                  r >>>= 1
                )
                  i++;
              ...
              (s.prototype.mulp = function (e, t, i) {
                ...
                (u.length = r),
                  ...
                  this.transform(n, d, a, s, r, f),
                  this.transform(c, d, h, o, r, f);
                for (var b = 0; b < r; b++) {
                  var l = a[b] * h[b] - s[b] * o[b];
                  (s[b] = a[b] * o[b] + s[b] * h[b]), (a[b] = l);
                }
                return (
                  this.conjugate(a, s, r),
                  this.transform(a, s, u, d, r, f),
              ...
              (m.prototype.pow = function (e) {
                var t = (function (e) {
                  for (
                    var t = new Array(e.bitLength()), i = 0;
                    i < t.length;
                    i++
                  ) {
                    var r = (i / 26) | 0,
              ...
              (m.prototype.iushrn = function (e, t, i) {
                ...
                if (0 !== d)
                  if (this.length > d)
                    for (this.length -= d, s = 0; s < this.length; s++)
                      this.words[s] = this.words[s + d];
                  else (this.words[0] = 0), (this.length = 1);
                for (
                  var c = 0, s = this.length - 1;
                  0 <= s && (0 !== c || r <= s);
                  s--
                ) {
              ...
              (m.prototype.isubn = function (e) {
                if ((p("number" == typeof e), p(e < 67108864), e < 0))
                  return this.iaddn(-e);
                if (0 !== this.negative)
                  return (
                    (this.negative = 0),
              ...
              (m.prototype._ishlnsubmul = function (e, t, i) {
                ...
                for (; n < this.length - i; n++)
                  (d = (r = (0 | this.words[n + i]) + d) >> 26),
                    (this.words[n + i] = 67108863 & r);
                if (0 === d) return this.strip();
                for (p(-1 === d), n = d = 0; n < this.length; n++)
                  (d = (r = -(0 | this.words[n]) + d) >> 26),
              ...
              (m.prototype._wordDiv = function (e, t) {
                ...
                for (var c = a - 1; 0 <= c; c--) {
                  var h =
                      67108864 * (0 | r.words[f.length + c]) +
                      (0 | r.words[f.length + c - 1]),
                ...
                return (
                  ...
                  this.isZero()
                    ...
                    ? ((d = this.neg().divmod(e, t)),
                      "mod" !== t && (r = d.div.neg()),
                      "div" !== t &&
                        ((f = d.mod.neg()), i && 0 !== f.negative && f.iadd(e)),
                      { div: r, mod: f })
                    : 0 === this.negative && 0 !== e.negative
                    ? ((d = this.divmod(e.neg(), t)),
                      { div: (r = "mod" !== t ? d.div.neg() : r), mod: d.mod })
                    : 0 != (this.negative & e.negative)
                    ? ((d = this.neg().divmod(e.neg(), t)),
                      "div" !== t &&
                        ((f = d.mod.neg()), i && 0 !== f.negative && f.isub(e)),
                      { div: d.div, mod: f })
              ...
              (m.prototype.modn = function (e) {
                p(e <= 67108863);
                for (
                  var t = (1 << 26) % e, i = 0, r = this.length - 1;
                  0 <= r;
                  r--
                )
              ...
              (m.prototype.egcd = function (e) {
                ...
                for (var s = i.clone(), c = t.clone(); !t.isZero(); ) {
                  ...
                  if (0 < h)
                    for (t.iushrn(h); 0 < h--; )
                      (r.isOdd() || f.isOdd()) && (r.iadd(s), f.isub(c)),
                        r.iushrn(1),
                        f.iushrn(1);
                  for (
                    var u = 0, b = 1;
                  ...
                  if (0 < u)
                    for (i.iushrn(u); 0 < u--; )
                      (d.isOdd() || n.isOdd()) && (d.iadd(s), n.isub(c)),
                        d.iushrn(1),
                        n.iushrn(1);
                  0 <= t.cmp(i)
                    ? (t.isub(i), r.isub(d), f.isub(n))
                    : (i.isub(t), d.isub(r), n.isub(f));
                }
                return { a: d, b: n, gcd: i.iushln(a) };
              }),
              (m.prototype._invmp = function (e) {
                ...
                for (
                  ...
                  if (0 < c)
                    for (r.iushrn(c); 0 < c--; )
                      d.isOdd() && d.iadd(n), d.iushrn(1);
                  0 <= i.cmp(r)
                    ? (i.isub(r), f.isub(d))
                    : (r.isub(i), d.isub(f));
                }
                return (
                  (t = 0 === i.cmpn(1) ? f : d).cmpn(0) < 0 && t.iadd(e), t
                );
              }),
              ...
              (m.prototype.toRed = function (e) {
                return (
                  p(!this.red, "Already a number in reduction context"),
              ...
              (m.prototype.redAdd = function (e) {
                return (
                  p(this.red, "redAdd works only with red numbers"),
                  this.red.add(this, e)
                );
              }),
              (m.prototype.redIAdd = function (e) {
                return (
                  p(this.red, "redIAdd works only with red numbers"),
                  this.red.iadd(this, e)
                );
              }),
              (m.prototype.redSub = function (e) {
                return (
                  p(this.red, "redSub works only with red numbers"),
                  this.red.sub(this, e)
                );
              }),
              (m.prototype.redISub = function (e) {
                return (
                  p(this.red, "redISub works only with red numbers"),
                  this.red.isub(this, e)
                );
              }),
              (m.prototype.redShl = function (e) {
                return (
                  p(this.red, "redShl works only with red numbers"),
                  this.red.shl(this, e)
                );
              }),
              (m.prototype.redMul = function (e) {
                return (
                  p(this.red, "redMul works only with red numbers"),
              ...
              (m.prototype.redSqr = function () {
                return (
                  p(this.red, "redSqr works only with red numbers"),
              ...
              (m.prototype.redSqrt = function () {
                return (
                  p(this.red, "redSqrt works only with red numbers"),
                  this.red._verify1(this),
                  this.red.sqrt(this)
                );
              }),
              (m.prototype.redInvm = function () {
                return (
                  p(this.red, "redInvm works only with red numbers"),
                  this.red._verify1(this),
                  this.red.invm(this)
                );
              }),
              (m.prototype.redNeg = function () {
                return (
                  p(this.red, "redNeg works only with red numbers"),
                  this.red._verify1(this),
                  this.red.neg(this)
                );
              }),
              (m.prototype.redPow = function (e) {
                return (
                  p(this.red && !e.red, "redPow(normalNum)"),
                  this.red._verify1(this),
                  this.red.pow(this, e)
                );
              });
            ...
            function w(e) {
              ...
              "string" == typeof e
                ...
                : (p(e.gtn(1), "modulus must be greater than 1"),
                  (this.m = e),
                  (this.prime = null));
            }
            function S(e) {
            ...
            (h.prototype._tmp = function () {
              ...
              (v.prototype.split = function (e, t) {
                ...
                var f = e.words[9];
                for (
                  t.words[t.length++] = 4194303 & f, r = 10;
                  r < e.length;
                  r++
                ) {
                  var d = 0 | e.words[r];
                  (e.words[r - 10] = ((4194303 & d) << 4) | (f >>> 22)),
                    (f = d);
                }
                (f >>>= 22),
                  0 === (e.words[r - 10] = f) && 10 < e.length
                    ? (e.length -= 10)
                    : (e.length -= 9);
              }),
          ...
          r.inherits(n, d),
            ...
            (n.prototype._update = function (e, t) {
              ...
              (this.h[0] = o(this.h[0], f)),
                (this.h[1] = o(this.h[1], d)),
                (this.h[2] = o(this.h[2], n)),
          ...
          r.inherits(s, n),
            ...
            (s.prototype._update = function (e, t) {
              ...
              var f = this.h[0],
                ...
                h = this.h[6],
                o = this.h[7];
              for (l(this.k.length === i.length), r = 0; r < i.length; r++)
              ...
              (this.h[0] = p(this.h[0], f)),
                (this.h[1] = p(this.h[1], d)),
                (this.h[2] = p(this.h[2], n)),
            ...
            (a.prototype._prepareBlock = function (e, t) {
              ...
              for (; r < i.length; r += 2) {
                var f = (function (e, t) {
                  ...
                  h = i[r - 32],
                  o = i[r - 31];
                (i[r] = l(f, d, n, a, s, c, h, o)),
                  (i[r + 1] = p(f, d, n, a, s, c, h, o));
              }
            }),
        ...
        function (e, t, i) {
          ...
          (i.inherits = e),
            (i.toArray = function (e, t) {
                ...
                if (t) {
                  ...
                  for (var d = 0, n = 0; n < e.length; n++) {
                    ...
                    a < 128
                      ? (f[d++] = a)
                      : a < 2048
                      ? ((f[d++] = (a >> 6) | 192), (f[d++] = (63 & a) | 128))
                      : ((r = n),
                        55296 != (64512 & (i = e).charCodeAt(r)) ||
                        r < 0 ||
                        r + 1 >= i.length ||
                        56320 != (64512 & i.charCodeAt(r + 1))
                          ? (f[d++] = (a >> 12) | 224)
                          : ((a =
                              65536 +
                              ((1023 & a) << 10) +
              ...
              else for (n = 0; n < e.length; n++) f[n] = 0 | e[n];
              return f;
            }),
            (i.toHex = function (e) {
            ...
            (i.split32 = function (e, t) {
              for (
                var i = new Array(4 * e.length), r = 0, f = 0;
                r < e.length;
                r++, f += 4
              ) {
                var d = e[r];
        ...
        function (e, t, i) {
          ...
          ((t.exports = n).prototype._init = function (e, t, i) {
            ...
            (n.prototype.generate = function (e, t, i, r) {
              ...
              "string" != typeof t && ((r = i), (i = t), (t = null)),
                i && ((i = d.toArray(i, r || "hex")), this._update(i));
