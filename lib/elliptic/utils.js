...
function hashToLEIntModN(hashFactory, n) {
  var hash = hashFactory();
  Array.prototype.slice.call(arguments, 2).forEach(hash.update.bind(hash));
  return intFromLE(hash.digest()).mod(n);
}
...
utils.hashToLEIntModN = hashToLEIntModN;
