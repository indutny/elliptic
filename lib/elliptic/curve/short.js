...
inherits(ShortCurve, curve.base);
...
ShortCurve.prototype._fixedNafMul = function _fixedNafMul(p, k) {
...
ShortCurve.prototype._wnafMul = function _wnafMul(p, k) {
  var w = 4;
...
ShortCurve.prototype._wnafMulAdd = function _wnafMulAdd(points, coeffs) {
